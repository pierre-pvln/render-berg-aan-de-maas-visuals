...
def build_footer():
    """
    Returns a HTML Footer element for the application Footer.
        ...
        children=[
            html.A(
                ...
                children=[
                    ...
                    html.Img(
                        # src="assets/img/ipheion-logo-2022-64x64.svg",
                        src="./assets/img/ipheion-logo-2022-darkest-with_grid-1024x1024.png",
                        id="ipheion-icon",
                        className="footer-element",
                        style={
                            'height': '2em',
